...
{
    public partial class asoPrestamo_Socio_View : SetimModulo
    {
        // Entidad base
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            hlReporteSolicitudPrestamo.NavigateUrl = ModuleContext.EditUrl("Rep_Solicitud");
            hlTablaAmortizacion.NavigateUrl = ModuleContext.EditUrl("Rep_Tabla");
        }
        ...
        private IList<asoPrestamo> ConsultaSP()
        {
            ...
            res = _EntidadControl._0SelByAll(
                null, //paginaEstado.Filtro_Estado,
                "asoSocio_Id", //paginaEstado.Filtro_Campo, 
                SocioId, //paginaEstado.Filtro_Valor,
