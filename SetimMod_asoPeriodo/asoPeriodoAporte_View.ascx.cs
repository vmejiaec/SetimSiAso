...
{
    public partial class asoPeriodoAporte_View : SetimModulo
    {
        // Entidad base
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                CargarDdl_Tipos();
                // Coloca los títulos
                lbCab_Periodo.Text = string.Format("Período: ({0}) - {1}", paginaEstadoMaster.Master_Id, paginaEstadoMaster.Master_Nombre);
                // Carga de datos
                ConsultaDatos();
            }
        ...
        private IList<asoPeriodoAporte> ConsultaSP()
        {
            ...
            res = _EntidadControl._0SelByAll(
                paginaEstadoMaster.Master_Id,  //asoPeriodo_Id: paginaEstadoMaster.Filtro_Periodo
                paginaEstado.Filtro_Tipo,           //tipo: 
                paginaEstado.Filtro_Estado,         //estado: 
        ...
        protected void ddlFiltro_Tipo_SelectedIndexChanged(object sender, EventArgs e)
        {
            var ddl = (DropDownList)sender;
        ...
        private void CargarDdl_Tipos()
        {
            ...
            ddlCab_Tipo.DataSource = lista;
            ddlCab_Tipo.DataTextField = "Texto";
            ddlCab_Tipo.DataValueField = "Valor";
            ddlCab_Tipo.DataBind();
            // Carga el estado del estado de la pagina
            ddlCab_Tipo.SelectedValue = paginaEstado.Filtro_Estado ?? "TOD";
        }
        // Carga los campos para filtrar 
        private void CargarDdl_CamposDelFiltro()
        {
            asoSetimListaDetControl SetimLista = new asoSetimListaDetControl();
            var lista = SetimLista._0SelBy_asoSetimLista_Nombre("asoPeriodoAporte_Filtro_Campos");
