...
{
    public partial class asoSocioInversion_View : SetimModulo
    {
        // Entidad base
        ...
        private IList<asoSocioInversion> ConsultaSP()
        {
        ...
        {
            asoSetimListaDetControl SetimLista = new asoSetimListaDetControl();
            var lista = SetimLista._0SelBy_asoSetimLista_Nombre("asoSocioInversion_Filtro_Campos");
