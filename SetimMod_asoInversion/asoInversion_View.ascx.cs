...
{
    public partial class asoInversion_View : SetimModulo
    {
        // Entidad base
        private readonly asoInversionControl _EntidadControl = new asoInversionControl();
        ...
        private IList<asoInversion> ConsultaSP()
        {
            IList<asoInversion> res = new List<asoInversion>();
            // En caso de filtrar por estado, utilizar paginaEstado.Filtro_Estado o paginaEstado.Filtro_Tipo
        ...
        private void CargarDdl_Tipos()
        {
            ...
            var lista = SetimLista._0SelBy_asoSetimLista_Nombre("asoInversion_Tipo");
            ...
            ddlCab_Tipo.SelectedValue = paginaEstado.Filtro_Tipo ?? "TOD";
        }
        // Carga los campos para filtrar 
        private void CargarDdl_CamposDelFiltro()
        {
            asoSetimListaDetControl SetimLista = new asoSetimListaDetControl();
            var lista = SetimLista._0SelBy_asoSetimLista_Nombre("asoInversion_Filtro_Campos");
