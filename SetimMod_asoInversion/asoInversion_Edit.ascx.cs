...
{
    public partial class asoInversion_Edit : SetimModulo
    {
        ...
        protected asoInversion ColocarDatosEnObjeto()
        {
            var o = new asoInversion();
            o.Id = _EntidadId;
        ...
        private void CargarDdl_Estados()
        {
            ...
            //var lista = SetimLista._0SelBy_asoSetimLista_Nombre("asoInversion_Estado");
            //lista.RemoveAt(0);
