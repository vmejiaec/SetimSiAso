...
<asp:DataGrid runat="server" ID="dgMaster"
    ...
    <Columns>
        ...
        <asp:BoundColumn DataField="asoPeriodo_Id"      HeaderText="Periodo_Id" HeaderStyle-Width="50px" SortExpression="asoPeriodo_Id" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0}" ItemStyle-HorizontalAlign="Right" />
        ...
        <asp:BoundColumn DataField="Valor_Comision"     HeaderText="Valor_Comision" HeaderStyle-Width="50px" SortExpression="Valor_Comision" HeaderStyle-HorizontalAlign="Center" DataFormatString="{0:N2}" ItemStyle-HorizontalAlign="Right" />
