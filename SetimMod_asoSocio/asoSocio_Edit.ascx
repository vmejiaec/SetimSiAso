...
<div id="dnnUsers" class="dnnForm dnnClear">
    ...
    <fieldset>
        ...
        <div class="dnnFormItem" >
            ...
            <asp:RequiredFieldValidator ID="rfvValor_Accion" runat="server" ControlToValidate="tbValor_Accion" CssClass="dnnFormMessage dnnFormError" Text="Requerido" ErrorMessage="Falta Valor_Accion"  SetFocusOnError="true" />
        </div>
        <div class="dnnFormItem" >
            ...
            <asp:RequiredFieldValidator ID="rfvValor_Ahorro" runat="server" ControlToValidate="tbValor_Ahorro" CssClass="dnnFormMessage dnnFormError" Text="Requerido" ErrorMessage="Falta Valor_Ahorro"  SetFocusOnError="true" />
        </div>
    </fieldset>
