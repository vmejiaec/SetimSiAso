<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="asoPeriodoCuota_ByPrestamo_Rep.ascx.cs" Inherits="SetimMod_asoPrestamo.asoPeriodoCuota_ByPrestamo_Rep" %>
