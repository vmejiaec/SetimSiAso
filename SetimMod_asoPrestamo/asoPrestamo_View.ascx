<%@ Control Language="C#" AutoEventWireup="True"
    CodeBehind="asoPrestamo_View.ascx.cs"
    Inherits="SetimMod_asoPrestamo.asoPrestamo_View" %>

<%@ Register TagPrefix="dnn" Namespace="DotNetNuke.UI.WebControls" Assembly="DotNetNuke" %>

<ul class="dnnActions dnnClear">
    <li><asp:HyperLink runat="server" ID="addButton" Text="Nuevo" CssClass="dnnPrimaryAction" /></li>
    <li><asp:HyperLink runat="server" ID="hlCuotas" Text="Cuotas" CssClass="dnnSecondaryAction" /></li>
</ul>
