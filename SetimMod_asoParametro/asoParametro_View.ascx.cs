...
{
    public partial class asoParametro_View : SetimModulo
    {
        // Entidad base
        ...
        private IList<asoParametro> ConsultaSP()
        {
        ...
        private void CargarDdl_CamposDelFiltro()
        {
            ...
            var lista = SetimLista._0SelBy_asoSetimLista_Nombre("asoParametro_Filtro_Campos");
